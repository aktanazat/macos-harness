...
It deliberately matches no vendor key format, so a secret scanner reading
this file has nothing to report. Keep it that way.
"""
...
CANARY = "CANARY_DO_NOT_LEAK_7f3a9c2b91"
